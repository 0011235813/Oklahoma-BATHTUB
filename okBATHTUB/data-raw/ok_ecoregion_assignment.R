# =============================================================================
# okBATHTUB — Ecoregion Assignment for Oklahoma Lake Monitoring Stations
#
# This script assigns EPA Level III ecoregions to Oklahoma lakes using a
# hardcoded geographic lookup table. It is shipped in data-raw/ as part
# of the provenance trail for the bundled `lake_ecoregion_lookup.csv`,
# not as a script that runs at install or load time.
#
...
#
# Output:
#   lake_ecoregion_lookup.csv        -- one row per lake, with ecoregion
#   ecoregion_summary.csv            -- summary by ecoregion
#   station_ecoregion_assignments.csv -- one row per monitoring station
#
# Dependencies: dplyr, readr, stringr
# Requires: a `scorecard` data frame in session with lake-level
#   summary statistics (see the original calibration workflow).
# =============================================================================
