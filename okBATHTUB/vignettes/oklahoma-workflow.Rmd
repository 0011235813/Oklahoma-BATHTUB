...
result <- ok_segment_chain(
  segments = list(
    riverine   = list(inflow_m3yr   = 1e9,
                      tp_inflow_ugl = 110,
                      tn_inflow_ugl = 1700,
                      surface_area_ha = 1200, mean_depth_m = 4),
    transition = list(surface_area_ha = 1800, mean_depth_m = 9),
    lacustrine = list(surface_area_ha = 2060, mean_depth_m = 25)
  ),
  coefficients = "oklahoma",
...
sweep <- ok_scenario_sweep(
  baseline,
  tp_reduction_pct = seq(0, 60, by = 10)
)
